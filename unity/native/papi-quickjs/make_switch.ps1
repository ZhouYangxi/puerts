# PapiQuickjs for Nintendo Switch - Build Script
# PowerShell version
...
# Build
Write-Host "Building PapiQuickjs..." -ForegroundColor Yellow
...
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "Static library: $BUILD_DIR\libPapiQuickjs.a" -ForegroundColor White
Write-Host "==========================================" -ForegroundColor Cyan
